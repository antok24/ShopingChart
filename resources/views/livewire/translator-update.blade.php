<form wire:submit.prevent="UpdateDataTranslator">
    <input type="hidden" name="" wire:model="translatorId">
    ...
    <div class="form-group row">
        <div class="col-sm-3">
            <button type="submit" class="btn btn-warning shadow float-right">Update</button>
        </div>
    </div>
</form>
